...
(function(global) {
  ...
  System.cacheBust = '?v=2.0.0'; // This is only the latest version that has HTML and JS changes whose cached files you want to bust. This is necessarily the current release!
